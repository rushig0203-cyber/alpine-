...
export const projects: Project[] = [
  {
    ...
    banner: astoniaDusk,
    overview:
      "Alpine Astonia is our most ambitious address yet — 197 premium apartments rising above a 39-shop retail plaza in Kiwale. Spread across 67,000 sqft of land and 4,00,000 sqft of built-up space, Astonia is designed as a self-contained landmark of contemporary living and curated street-level retail.",
    highlights: [
      "Plot area: 67,000 sqft",
      "Built-up area: 4,00,000 sqft",
      "197 premium apartments",
      "39 ground-level retail shops",
      "Expansive private balconies",
      "Landscaped entrance plaza & podium",
    ],
    amenities: [
      "Swimming Pool",
    ...
    floorPlans: [
      { label: "2 BHK · Carpet 722.15 sq.ft.", image: plan2bhk.url },
      { label: "3 BHK · Carpet 1009.87 sq.ft.", image: plan3bhk.url },
    ],
    configurations: ["2 BHK", "3 BHK"],
    quickFacts: [
      { label: "Units", value: "197 Apartments" },
      { label: "Retail", value: "39 Shops" },
      { label: "Plot Area", value: "67,000 sqft" },
      { label: "Built-Up", value: "4,00,000 sqft" },
    ],
